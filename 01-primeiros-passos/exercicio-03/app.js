...
"maleDogNames";
- Agora, em uma const "female DogNames", armazene um array com os  
...
*/
// COMO EU FIZ:
// const dessert = `${dogNames[0][dogNames[0].length - 2]}${dogNames[0][dogNames[0].length - 1]}${dogNames[1][dogNames[1].length - 2]}${dogNames[1][dogNames[1].length - 1]}${dogNames[3][dogNames[3].length - 2].replace('n', 'd')}${dogNames[3][dogNames[3].length - 1]}`
